...
<%@ Page language="c#" Codebehind="register.aspx.cs" AutoEventWireup="false" Inherits="funstore.register" %>
...
<HTML>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			...
			<DIV style="Z-INDEX: 101; LEFT: 288px; WIDTH: 576px; POSITION: absolute; TOP: 176px; HEIGHT: 464px; BACKGROUND-COLOR: lightgrey"
				ms_positioning="GridLayout"><asp:label id="Label1" style="Z-INDEX: 101; LEFT: 24px; POSITION: absolute; TOP: 16px" runat="server"
					...
					runat="server" Width="96px" Text="REGISTER" ForeColor="#C04000" Font-Bold="True"></asp:button><asp:button id="Button2" style="Z-INDEX: 113; LEFT: 256px; POSITION: absolute; TOP: 416px" runat="server"
					Width="104px" Text="RESET" ForeColor="#C04000" Font-Bold="True"></asp:button><asp:textbox id="txtfname" style="Z-INDEX: 114; LEFT: 112px; POSITION: absolute; TOP: 16px" runat="server"></asp:textbox><asp:textbox id="txtaddress" style="Z-INDEX: 115; LEFT: 112px; POSITION: absolute; TOP: 48px"
