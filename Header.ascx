<%@ Control Language="c#" AutoEventWireup="false" Codebehind="Header.ascx.cs" Inherits="funstore.Header" TargetSchema="http://schemas.microsoft.com/intellisense/ie5"%>
<DIV style="WIDTH: 944px; POSITION: relative; HEIGHT: 128px" ms_positioning="GridLayout">
