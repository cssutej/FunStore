...
<%@ Page language="c#" Codebehind="login.aspx.cs" AutoEventWireup="false" Inherits="funstore.login" %>
		...
		<form id="Form1" method="post" runat="server">
			...
			<P>
				<TABLE id="Table1" style="Z-INDEX: 101; LEFT: 360px; WIDTH: 400px; POSITION: absolute; TOP: 216px; HEIGHT: 178px; BACKGROUND-COLOR: #ffffcc"
					...
					<TR>
						<TD style="WIDTH: 170px" align="center"><asp:button id="btnLogin" runat="server" Width="108px" Text="LOGIN"></asp:button></TD>
						<TD style="WIDTH: 167px" align="center" colSpan="2">&nbsp;
							<asp:button id="btnReset" runat="server" Width="100px" Text="RESET"></asp:button></TD>
					</TR>
				</TABLE>
			</P>
			<P>&nbsp;</P>
