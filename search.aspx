...
<%@ Page language="c#" Codebehind="search.aspx.cs" AutoEventWireup="false" Inherits="funstore.search" %>
		...
		<form id="Form1" method="post" runat="server">
			<P>
				...
				<asp:Button id="btnSearch" style="Z-INDEX: 103; LEFT: 656px; POSITION: absolute; TOP: 160px"
					runat="server" Width="64px" Font-Bold="True" Text="GO" ForeColor="Blue" Font-Names="Bodoni MT Black"></asp:Button>
